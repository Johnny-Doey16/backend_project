...
type ViewPostRequest struct {
	...
	Viewed bool   `protobuf:"varint,2,opt,name=viewed,proto3" json:"viewed,omitempty"`              // True if like, false if unlike
}
...
func (x *ViewPostRequest) GetViewed() bool {
	if x != nil {
		return x.Viewed
	}
	return false
...
type ViewPostResponse struct {
	...
	ViewCount int64  `protobuf:"varint,2,opt,name=view_count,json=viewCount,proto3" json:"view_count,omitempty"` // The new like count for the post
}
...
func (x *ViewPostResponse) GetPostId() string {
	if x != nil {
		return x.PostId
	}
	return ""
...
func (x *ViewPostResponse) GetViewCount() int64 {
	if x != nil {
		return x.ViewCount
	}
	return 0
...
type ViewUpdate struct {
	...
	NewViews int64  `protobuf:"varint,2,opt,name=new_views,json=newViews,proto3" json:"new_views,omitempty"`
}
...
func (x *ViewUpdate) GetPostId() string {
	if x != nil {
		return x.PostId
	}
	return ""
...
func (x *ViewUpdate) GetNewViews() int64 {
	if x != nil {
		return x.NewViews
	}
	return 0
...
var file_view_proto_rawDesc = []byte{
	...
	0x22, 0x42, 0x0a, 0x0f, 0x56, 0x69, 0x65, 0x77, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75,
	...
	0x76, 0x69, 0x65, 0x77, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x76, 0x69,
	0x65, 0x77, 0x65, 0x64, 0x22, 0x4a, 0x0a, 0x10, 0x56, 0x69, 0x65, 0x77, 0x50, 0x6f, 0x73, 0x74,
	...
	0x22, 0x42, 0x0a, 0x0a, 0x56, 0x69, 0x65, 0x77, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x17,
	0x0a, 0x07, 0x70, 0x6f, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x06, 0x70, 0x6f, 0x73, 0x74, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x65, 0x77, 0x5f, 0x76,
	0x69, 0x65, 0x77, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6e, 0x65, 0x77, 0x56,
	0x69, 0x65, 0x77, 0x73, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_view_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_view_proto_goTypes = []interface{}{
	(*ViewPostRequest)(nil),  // 0: pb.ViewPostRequest
	(*ViewPostResponse)(nil), // 1: pb.ViewPostResponse
	(*ViewUpdate)(nil),       // 2: pb.ViewUpdate
}
