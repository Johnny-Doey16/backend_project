...
func (x *CreateUserRequest) GetFcmToken() string {
	if x != nil {
		return x.FcmToken
	}
	return ""
...
func (x *CreateUserResponse) GetAccessTokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
...
var file_rpc_create_user_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7e, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61,
	...
	0x66, 0x63, 0x6d, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xa8, 0x01, 0x0a, 0x12, 0x43, 0x72, 0x65,
	...
	0x73, 0x41, 0x74, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_rpc_create_user_proto_depIdxs = []int32{
	...
	3, // 1: pb.CreateUserResponse.access_token_expires_at:type_name -> google.protobuf.Timestamp
