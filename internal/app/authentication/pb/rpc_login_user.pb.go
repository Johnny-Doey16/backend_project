...
type LoginUserRequest struct {
	...
	Identifier string `protobuf:"bytes,1,opt,name=identifier,proto3" json:"identifier,omitempty"` // email or username or phone
...
func (x *LoginUserRequest) GetIdentifier() string {
	if x != nil {
		return x.Identifier
	}
	return ""
...
func (x *LoginUserRequest) GetFcmToken() string {
	if x != nil {
		return x.FcmToken
	}
	return ""
...
func (x *LoginUserResponse) GetAuthInfo() *AuthTokenInfo {
	if x != nil {
		return x.AuthInfo
	}
	return nil
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x15, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6b, 0x0a,
	...
	0x52, 0x08, 0x66, 0x63, 0x6d, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x60, 0x0a, 0x11, 0x4c, 0x6f,
	...
	0x70, 0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x2d, 0x0a,
	0x08, 0x61, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x11, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x6e,
	0x66, 0x6f, 0x52, 0x08, 0x61, 0x75, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x28, 0x5a, 0x26,
...
var file_rpc_login_user_proto_goTypes = []interface{}{
	...
	(*User)(nil),              // 2: pb.User
	(*AuthTokenInfo)(nil),     // 3: pb.AuthTokenInfo
}
var file_rpc_login_user_proto_depIdxs = []int32{
	2, // 0: pb.LoginUserResponse.user:type_name -> pb.User
	3, // 1: pb.LoginUserResponse.authInfo:type_name -> pb.AuthTokenInfo
