...
// The request message containing no data for ResendVerification.
...
// The response message containing the outcome of the ResendVerification operation.
type ResendVerificationResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// A message or a status code to signify whether the operation was successful.
...
// The request message containing the data needed to verify an email.
type VerifyEmailRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The verification token or code that was sent to the user's email.
...
func (x *VerifyEmailRequest) Reset() {
	*x = VerifyEmailRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_verify_email_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VerifyEmailRequest) Descriptor() ([]byte, []int) {
	return file_rpc_verify_email_proto_rawDescGZIP(), []int{2}
}
...
// The response message containing the outcome of the VerifyEmail operation.
type VerifyEmailResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// A message or a status code to signify whether the email verification was successful.
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
}
...
func (x *VerifyEmailResponse) Reset() {
	*x = VerifyEmailResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rpc_verify_email_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VerifyEmailResponse) Descriptor() ([]byte, []int) {
	return file_rpc_verify_email_proto_rawDescGZIP(), []int{3}
}
...
var file_rpc_verify_email_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x1b, 0x0a, 0x19,
	0x52, 0x65, 0x73, 0x65, 0x6e, 0x64, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x36, 0x0a, 0x1a, 0x52, 0x65, 0x73,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x28,
...
var file_rpc_verify_email_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
func file_rpc_verify_email_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_verify_email_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rpc_verify_email_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
